...
fn test_blur_1r2(){
    ...
    //TODO Remove unwraps
    let r1_2_truth = image::open("tests/truth/Gauss_Blur/gauss2d_boy_r1.2.png").unwrap().to_luma8();
...
fn test_blur_2r5(){
    ...
    //TODO Remove unwraps
    let r2_5_truth = image::open("tests/truth/Gauss_Blur/gauss2d_boy_r2.5.png").unwrap().to_luma8();
...
fn test_blur_4r0(){
    ...
    //TODO Remove unwraps
    let r4_0_truth = image::open("tests/truth/Gauss_Blur/gauss2d_boy_r4.0.png").unwrap().to_luma8();
...
fn test_highpass_1r2(){
    ...
    //TODO Remove unwraps
    let r1_2_truth = image::open("tests/truth/Highpass/highpass2d_boy_r1.2.png").unwrap().to_luma8();

    assert_eq!(subtract_and_compare(&highpass2d_conv_result, &r1_2_truth),0);
}
...
fn test_highpass_1r8(){
    ...
    //TODO Remove unwraps
    let r1_8_truth = image::open("tests/truth/Highpass/highpass2d_boy_r1.8.png").unwrap().to_luma8();

    assert_eq!(subtract_and_compare(&highpass2d_conv_result, &r1_8_truth),0);
}
...
fn test_highpass_2r5(){
    ...
    //TODO Remove unwraps
    let r2_5_truth = image::open("tests/truth/Highpass/highpass2d_boy_r2.5.png").unwrap().to_luma8();

    assert_eq!(subtract_and_compare(&highpass2d_conv_result, &r2_5_truth),0);
}
...
fn test_highpass_4r0(){
    ...
    //TODO Remove unwraps
    let r4_0_truth = image::open("tests/truth/Highpass/highpass2d_boy_r4.0.png").unwrap().to_luma8();

    assert_eq!(subtract_and_compare(&highpass2d_conv_result, &r4_0_truth),0);
}
